...
func main() {
	...
	log.Println("\n✅ Demo complete. In production, this would keep running to accept API calls.")
	log.Println("💡 To keep running, add an HTTP server or message queue listener.")
	
	// Keep service running (infinite loop)
	log.Println("⏳ Service ready - waiting for signals...")
	for {
