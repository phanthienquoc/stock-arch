...
**Deployment target**: Staging VPS (`/opt/trading`)
...
**Deployment target**: Production VPS (`/opt/trading`)
...
Verify: /opt/trading directory exists and is writable
```
